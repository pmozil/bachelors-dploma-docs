...
Multi-processs benchmarks on linux are a logical extension of the benchmarks
done in \autoref{subsec:gzip_impl}. Testing CXU and IO contention, as well
as how IO and CXU compute may contend or compensate each other is an important
